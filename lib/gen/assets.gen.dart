...
class $AssetsPngGen {
  ...
  /// File path: assets/png/errorimage_placeholder.png
  AssetGenImage get errorimagePlaceholder =>
      const AssetGenImage('assets/png/errorimage_placeholder.png');

  /// File path: assets/png/splashscreen-image.webp
  AssetGenImage get splashscreenImage =>
      const AssetGenImage('assets/png/splashscreen-image.webp');

  /// List of all assets
  List<AssetGenImage> get values => [errorimagePlaceholder, splashscreenImage];
}
